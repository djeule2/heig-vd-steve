...
--  *
   ...
   pragma Import (C, glutStrokeRoman, "glutStrokeRoman");
   ...
   pragma Import (C, glutBitmap9By15, "glutBitmap9By15");

   glutBitmap8By13 : aliased Interfaces.C.Extensions.Void_Ptr;
   pragma Import (C, glutBitmap8By13, "glutBitmap8By13");
   ...
   pragma Import (Ada, glutInit, "glutInit");
